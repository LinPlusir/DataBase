...
public class StaffAddInterFrame extends JInternalFrame {
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(phone, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(phoneTxt, GroupLayout.PREFERRED_SIZE, 188, GroupLayout.PREFERRED_SIZE)))
					.addGap(32)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
	...
	private void StaffAddActionPerformed(ActionEvent e) {
		...
		Staff staff=new Staff(staff_name,staff_id, gender, departid, postid, phone);
		Connection con=null;
		try {
			con=dbUtil.getCon();
