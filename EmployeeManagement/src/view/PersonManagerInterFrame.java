...
public class PersonManagerInterFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonManagerInterFrame frame = new PersonManagerInterFrame();
	 ...
	 * Create the frame.
	 */
	public PersonManagerInterFrame() {
		setIconifiable(true);
		setClosable(true);
		setEnabled(false);
		setTitle("基本信息维护");
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnNewButton_1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 262, GroupLayout.PREFERRED_SIZE))
					.addGap(305))
		);
